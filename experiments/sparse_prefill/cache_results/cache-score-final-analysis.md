...
## cache-score-invariant-replication.json

真实权重：Qwen3-0.6B；batch-invariant=1；每条轨迹计入第一轮冷请求，每轮重复前清空缓存。

| 轨迹 | 模式 | 次数 | 总耗时中位数 ms | P10–P90 ms | 相对 full 配对加速比 | 95% bootstrap 区间 |
| --- | --- | --- | --- | --- | --- | --- |
| 1 | full | 10 | 673.43 | 672.62–674.04 | 1.000 | 1.000–1.000 |
| 1 | sparse | 10 | 598.82 | 597.64–599.46 | 1.125 | 1.124–1.126 |
| 1 | cache | 10 | 270.02 | 268.99–270.72 | 2.495 | 2.491–2.499 |
| 1 | unsafe | 10 | 295.53 | 294.42–325.81 | 2.279 | 2.271–2.284 |

| 2 | full | 10 | 220.84 | 219.76–221.75 | 1.000 | 1.000–1.000 |
| 2 | sparse | 10 | 197.09 | 196.18–198.37 | 1.119 | 1.115–1.122 |
| 2 | cache | 10 | 103.58 | 102.68–104.67 | 2.126 | 2.118–2.142 |
| 2 | unsafe | 10 | 112.07 | 111.47–113.05 | 1.967 | 1.958–1.974 |
